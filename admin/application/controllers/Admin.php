...
class Admin extends CI_Controller {
	...
	function hapus_kandidat($id){
		...
		$this->session->set_flashdata('hapus', 'Candidato berhasil dihapus');
		redirect($this->agent->referrer());
	}

	public function pemilih(){
		$data['title'] = 'Lista de votantes';
	...
	function ganti_user_admin($id){
		...
		$this->session->set_flashdata('ganti_user', 'Nombre/Username berhasil diubah');
		redirect($this->agent->referrer());
	}
