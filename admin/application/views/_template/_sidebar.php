    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?=($this->uri->segment(1)=='kandidat') ? 'class="active"' : '' ?>>
          <a href="<?=base_url('kandidat');?>"><i class="fa fa-user"></i> <span>Candidato</span>
        ...
        <li <?=($this->uri->segment(1)=='pemilih') ? 'class="active"' : ''?>>
          <a href="<?=base_url('pemilih');?>"><i class="fa fa-users"></i> <span>Votante</span>
            <span class="pull-right-container">
        ...
        <li <?=($this->uri->segment(1)=='pengaturan') ? 'class="active"' : ''?>>
          <a href="<?=base_url('pengaturan')?>"><i class="fa fa-gear"></i> <span>Configuración</span></a>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->