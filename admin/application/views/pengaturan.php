	<div class="row">
				...
				<div class="box-body">
					<form action="<?=base_url('admin/ganti_user_admin/'.$this->session->id)?>" method="POST">
						<div class="form-group">
							...
							<input type="text" name="nama" value="<?=$this->session->nama;?>" class="form-control" placeholder="Insertar Nombre Administrator" required>
						</div>
						<div class="form-group">
							<label for="Username">Username :</label>
							<input type="text" name="username" value="<?=$this->session->username;?>" class="form-control" placeholder="Insertar Username Administrator" required>
						</div>
		...
		<div class="col-sm-6">
			<div class="box box-danger box-solid">
				<div class="box-header">
					<h4 class="box-title">Cambia la contraseña</h4>
				</div>
				<div class="box-body">
					<?php if($passdefault): ?>
					...
					<form action="<?=base_url('admin/ganti_pass_admin/'.$this->session->id)?>" method="POST">
						<div class="form-group">
							<label for="PasswordLama">Contraseña anterior :</label>
							<input type="password" name="passwdlama" class="form-control" placeholder="Insertar Contraseña anterior" required>
						</div>
						<div class="form-group">
							<label for="PasswordBaru">Nueva contraseña :</label>
							<input type="password" name="passwdbaru" class="form-control" placeholder="Insertar Password Baru" required>
						</div>
						<button class="btn btn-flat btn-danger btn-sm">Simpan</button>
					</form>
				</div>
		...
		<div class="col-sm-12">
			<div class="box box-danger box-solid">
				<div class="box-header">
					<h4 class="box-title"><i class="fa fa-warning"></i> Restablecer aplicación</h4>
				</div>
				<div class="box-body">
					<p>*Restablecer la aplicación eliminará todos los datos excepto los datos del administrador</p>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="formTambah">
						<div class="form-group">
							<label for="Nombre">Nombre :</label>
							<input type="text" name="nama" class="form-control" placeholder="Insertar Nombre Administrator">
						</div>
						<div class="form-group">
							<label for="Username">Username :</label>
							<input type="text" name="username" class="form-control" placeholder="Insertar Username Administrator">
						</div>
	...
	<?=($this->session->flashdata('ganti_user')) ? '<script>Swal.fire("Berhasil", "Nombre/Username berhasil diubah", "success")</script>' : ''?>
